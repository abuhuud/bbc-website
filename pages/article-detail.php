...
<head>
    ...
    <title>Baca Artikel | BAZNAS Badminton Club</title>
    <meta name="description" content="Baca artikel dan berita lengkap seputar BAZNAS Badminton Club (BBC) BAZNAS RI.">    <!-- Favicon -->
            ...
            <div class="container container-narrow">
                ...
                <div id="article-detail-container">
                    <div style="text-align: center; padding: 40px;">
                        <span class="pixel-badge pixel-badge--green">MEMUAT ARTIKEL...</span>
                    </div>
                </div>
            </div>
        </section>
